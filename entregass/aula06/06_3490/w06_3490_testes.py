...
import w06_3490_fila_encadeada as fila
import w06_3490_pilha_encadeada as pilha
...
class Teste_da_PilhaEncadeada(test.TestCase):
    def setUp(self):
        ...
        self.pilha=pilha.PilhaEncadeada()
...
class Teste_da_Fila_Encadeada(test.TestCase):
    ...
    def test_uso_de_msm_instan(self):
        ...
        teste_de_vazio=fils.esta_vazio()
